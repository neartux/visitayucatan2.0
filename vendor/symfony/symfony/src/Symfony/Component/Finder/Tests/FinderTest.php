...
class FinderTest extends Iterator\RealIteratorTestCase
{
    ...
    public function testFiles()
    {
        ...
        $this->assertIterator($this->toAbsolute(array('foo/bar.tmp', 'test.html.twig', 'test.py', 'foo bar')), $finder->in(self::$tmpDir)->getIterator());
    ...
    public function testDepth()
    {
        ...
        $this->assertIterator($this->toAbsolute(array('foo', 'test.html.twig', 'test.py', 'toto', 'foo bar')), $finder->in(self::$tmpDir)->getIterator());
    ...
    public function testName()
    {
        ...
        $this->assertIterator($this->toAbsolute(array('test.html.twig')), $finder->in(self::$tmpDir)->getIterator());

        $finder = $this->buildFinder();
        $finder->name('test.ph*');
        $finder->name('test.py');
        $this->assertIterator($this->toAbsolute(array('test.html.twig', 'test.py')), $finder->in(self::$tmpDir)->getIterator());
    ...
    public function testRegexName($regex)
    {
        $finder = $this->buildFinder();
        $finder->name($regex);
        $this->assertIterator($this->toAbsolute(array('test.py', 'test.html.twig')), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testDate()
    {
        ...
        $this->assertIterator($this->toAbsolute(array('foo/bar.tmp', 'test.html.twig')), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testExclude()
    {
        ...
        $this->assertIterator($this->toAbsolute(array('test.html.twig', 'test.py', 'toto', 'foo bar')), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testIgnoreVCS()
    {
        ...
        $this->assertIterator($this->toAbsolute(array('.git', 'foo', 'foo/bar.tmp', 'test.html.twig', 'test.py', 'toto', 'toto/.git', '.bar', '.foo', '.foo/.bar', '.foo/bar', 'foo bar')), $finder->in(self::$tmpDir)->getIterator());
        ...
        $this->assertIterator($this->toAbsolute(array('foo', 'foo/bar.tmp', 'test.html.twig', 'test.py', 'toto', '.bar', '.foo', '.foo/.bar', '.foo/bar', 'foo bar')), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testIgnoreDotFiles()
    {
        ...
        $this->assertIterator($this->toAbsolute(array('.git', '.bar', '.foo', '.foo/.bar', '.foo/bar', 'foo', 'foo/bar.tmp', 'test.html.twig', 'test.py', 'toto', 'toto/.git', 'foo bar')), $finder->in(self::$tmpDir)->getIterator());
        ...
        $this->assertIterator($this->toAbsolute(array('foo', 'foo/bar.tmp', 'test.html.twig', 'test.py', 'toto', 'foo bar')), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testSortByName()
    {
        ...
        $this->assertIterator($this->toAbsolute(array('foo', 'foo bar', 'foo/bar.tmp', 'test.html.twig', 'test.py', 'toto')), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testSortByType()
    {
        ...
        $this->assertIterator($this->toAbsolute(array('foo', 'foo bar', 'toto', 'foo/bar.tmp', 'test.html.twig', 'test.py')), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testSortByAccessedTime()
    {
        ...
        $this->assertIterator($this->toAbsolute(array('foo/bar.tmp', 'test.html.twig', 'toto', 'test.py', 'foo', 'foo bar')), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testSortByChangedTime()
    {
        ...
        $this->assertIterator($this->toAbsolute(array('toto', 'test.py', 'test.html.twig', 'foo/bar.tmp', 'foo', 'foo bar')), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testIn()
    {
        ...
        $expected = array(
            self::$tmpDir.DIRECTORY_SEPARATOR.'test.html.twig',
    ...
    public function testRelativePathname()
    {
        ...
        $ref = array('test.html.twig', 'toto', 'test.py', 'foo', 'foo'.DIRECTORY_SEPARATOR.'bar.tmp', 'foo bar');
    ...
    public function testAdaptersChaining()
    {
        ...
        $filenames = $this->toAbsolute(array('foo', 'foo/bar.tmp', 'test.html.twig', 'test.py', 'toto'));
    ...
    public function testAccessDeniedException()
    {
        ...
        if (false === $couldRead = is_readable($testDir)) {
            try {
                $this->assertIterator($this->toAbsolute(array('foo bar', 'test.html.twig', 'test.py')), $finder->getIterator());
