...
--
-- Servidor: localhost
-- Tiempo de generación: 16-03-2016 a las 22:31:59
...
(5, 'direcion del hotel', NULL, '9991', NULL, NULL),
(6, NULL, NULL, NULL, NULL, 'near'),
(7, NULL, NULL, NULL, NULL, 'near');
...
INSERT INTO `hotel` (`id`, `id_estatus`, `id_datosubicacion`, `id_destino`, `descripcion`, `estrellas`, `promovido`) VALUES
(1, 1, 5, 1, 'colonial', 5, 0);
...
--
-- Volcado de datos para la tabla `hotel_contacto`
--

INSERT INTO `hotel_contacto` (`id`, `id_datospersonales`, `id_datosubicacion`, `id_hotel`, `id_estatus`) VALUES
(1, 5, 6, 1, 1),
(2, 6, 7, 1, 1);
...
--
-- Estructura de tabla para la tabla `hotel_contrato`
--

CREATE TABLE IF NOT EXISTS `hotel_contrato` (
  `id` int(11) NOT NULL,
  `id_hotel` int(11) NOT NULL,
  ...
  `aplicaimpuesto` tinyint(1) NOT NULL,
  `ish` double NOT NULL,
...
--
-- Volcado de datos para la tabla `hotel_contrato`
--

INSERT INTO `hotel_contrato` (`id`, `id_hotel`, `id_plan`, `id_estatus`, `descripcion`, `fechainicio`, `fechafin`, `edadmenor`, `aplicaimpuesto`, `ish`, `markup`, `iva`, `fee`) VALUES
(1, 1, 1, 1, 'TESTING3', '2016-02-24', '2016-02-24', 1, 0, 2, 3, 4, 5),
(2, 1, 1, 2, 'TESTING3', '2016-02-24', '2016-02-24', 1, 0, 2, 3, 4, 5),
(3, 1, 1, 1, 'df', '2016-03-23', '2016-03-23', 23, 1, 0, 0, 0, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `hotel_fecha_cierre`
--

CREATE TABLE IF NOT EXISTS `hotel_fecha_cierre` (
  `id` int(11) NOT NULL,
  `id_hotel` int(11) NOT NULL,
  `fechainicio` date NOT NULL,
  `fechafin` date NOT NULL,
...
--
-- Volcado de datos para la tabla `hotel_fecha_cierre`
--

INSERT INTO `hotel_fecha_cierre` (`id`, `id_hotel`, `fechainicio`, `fechafin`, `id_estatus`) VALUES
(1, 1, '2016-02-01', '1970-01-01', 2),
(2, 1, '2016-02-01', '1970-01-01', 2),
(3, 1, '2016-02-01', '1969-12-31', 2),
(4, 1, '2016-02-01', '1969-12-31', 2),
(5, 1, '2016-02-01', '1969-12-31', 2),
(6, 1, '2016-02-01', '2016-02-06', 1),
(7, 1, '2016-01-02', '2016-03-17', 2),
(8, 1, '2016-02-01', '2016-02-27', 2),
(9, 1, '2016-02-23', '2016-02-23', 2),
(10, 1, '2016-02-01', '2016-02-03', 2),
(11, 1, '2016-02-01', '2016-02-03', 2),
(12, 1, '2016-02-02', '2016-02-09', 1),
(13, 1, '2016-02-04', '2016-02-26', 1),
(14, 1, '2016-02-02', '2016-02-09', 1),
(15, 1, '2016-03-01', '2016-03-01', 1);
...
CREATE TABLE IF NOT EXISTS `hotel_habitacion` (
  ...
  `descripcion` longtext COLLATE utf8_unicode_ci NOT NULL,
  `maximoinfantes` int(11) DEFAULT NULL,
  `maximomenores` int(11) NOT NULL,
  `maximojuniors` int(11) DEFAULT NULL,
  `maximoadultos` int(11) NOT NULL,
...
INSERT INTO `hotel_habitacion` (`id`, `id_hotel`, `nombre`, `descripcion`, `maximoinfantes`, `maximomenores`, `maximojuniors`, `maximoadultos`, `capacidadmaxima`, `allotment`, `id_estatus`) VALUES
(1, 1, 'Estandar', '<p>dlfkjsfdfdfsdf1</p>', 0, 11, 0, 21, 31, 31, 1),
(2, 1, 'Doble', '<p>descripcion de la habitacion&nbsp;&nbsp;&nbsp;&nbsp;</p>', 0, 1, 0, 2, 3, 4, 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `hotel_habitacion_idioma`
--

CREATE TABLE IF NOT EXISTS `hotel_habitacion_idioma` (
  `id` int(11) NOT NULL,
  `id_hotel_habitacion` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `hotel_habitacion_idioma`
--

INSERT INTO `hotel_habitacion_idioma` (`id`, `id_hotel_habitacion`, `id_idioma`, `id_estatus`, `descripcion`) VALUES
(1, 1, 1, 1, 'Descripcion del idioma en español estandaarupdate12345454666'),
(3, 1, 2, 1, 'decipcion en ingles estandar'),
(4, 2, 4, 1, 'habitacion &nbsp;doble en francesadsfasf'),
(5, 1, 3, 1, 'italiano estandar');
...
--
-- Volcado de datos para la tabla `hotel_imagen`
--

INSERT INTO `hotel_imagen` (`id`, `id_hotel`, `id_estatus`, `nombreoriginal`, `nombre`, `path`, `tipoarchivo`, `folio`, `fechacreacion`, `principal`) VALUES
(1, 1, 1, 'detalle.png', 'hotel-1-folio-1.png', 'bundles/VisitaYucatanBundle/images/hoteles/hotel-1-folio-1.png', 'png', 1, '2016-02-23 21:24:07', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `hotel_plan`
--

CREATE TABLE IF NOT EXISTS `hotel_plan` (
  `id` int(11) NOT NULL,
  `id_estatus` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `hotel_plan`
--

INSERT INTO `hotel_plan` (`id`, `id_estatus`, `descripcion`) VALUES
(1, 1, 'Todo incluido');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `hotel_tarifa`
--

CREATE TABLE IF NOT EXISTS `hotel_tarifa` (
  `id` int(11) NOT NULL,
  `id_hotel` int(11) NOT NULL,
  `id_hotel_contrato` int(11) NOT NULL,
  `id_hotel_habitacion` int(11) NOT NULL,
  `id_estatus` int(11) NOT NULL,
  `fecha` date NOT NULL,
  `sencillo` double NOT NULL,
  `doble` double NOT NULL,
  `triple` double NOT NULL,
  `cuadruple` double NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=75 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Volcado de datos para la tabla `hotel_tarifa`
--

INSERT INTO `hotel_tarifa` (`id`, `id_hotel`, `id_hotel_contrato`, `id_hotel_habitacion`, `id_estatus`, `fecha`, `sencillo`, `doble`, `triple`, `cuadruple`) VALUES
(37, 1, 1, 1, 1, '2016-03-01', 10, 20, 30, 40),
(38, 1, 1, 1, 1, '2016-03-02', 10, 20, 30, 40),
(39, 1, 1, 1, 1, '2016-03-03', 10, 20, 30, 40),
(40, 1, 1, 1, 1, '2016-03-04', 10, 20, 30, 40),
(41, 1, 1, 1, 1, '2016-03-05', 10, 20, 30, 40),
(42, 1, 1, 1, 1, '2016-03-06', 10, 20, 30, 40),
(43, 1, 1, 1, 1, '2016-03-07', 10, 20, 30, 40),
(44, 1, 1, 1, 1, '2016-03-08', 10, 20, 30, 40),
(45, 1, 1, 1, 1, '2016-03-09', 10, 20, 30, 40),
(46, 1, 1, 1, 1, '2016-03-10', 10, 20, 30, 40),
(47, 1, 1, 1, 1, '2016-03-11', 10, 20, 30, 40),
(48, 1, 1, 1, 1, '2016-03-12', 10, 20, 30, 40),
(49, 1, 1, 1, 1, '2016-03-13', 10, 20, 30, 40),
(50, 1, 1, 1, 1, '2016-03-14', 10, 20, 30, 40),
(51, 1, 1, 1, 1, '2016-03-15', 10, 20, 30, 40),
(52, 1, 1, 1, 1, '2016-03-16', 10, 20, 30, 40),
(53, 1, 1, 1, 1, '2016-03-17', 10, 20, 30, 40),
(54, 1, 1, 1, 1, '2016-03-18', 10, 20, 30, 40),
(55, 1, 1, 1, 1, '2016-03-19', 10, 20, 30, 40),
(56, 1, 1, 1, 1, '2016-03-20', 10, 20, 30, 40),
(57, 1, 1, 1, 1, '2016-03-21', 10, 20, 30, 40),
(58, 1, 1, 1, 1, '2016-03-22', 10, 20, 30, 40),
(59, 1, 1, 1, 1, '2016-03-23', 10, 20, 30, 40),
(60, 1, 1, 1, 1, '2016-03-24', 10, 20, 30, 40),
(68, 1, 1, 1, 1, '2016-03-25', 10, 20, 30, 50),
(69, 1, 1, 1, 1, '2016-03-26', 10, 20, 30, 50),
(70, 1, 1, 1, 1, '2016-03-27', 10, 20, 30, 50),
(71, 1, 1, 1, 1, '2016-03-28', 10, 20, 30, 50),
(72, 1, 1, 1, 1, '2016-03-29', 10, 20, 30, 50),
(73, 1, 1, 1, 1, '2016-03-30', 10, 20, 30, 50),
(74, 1, 1, 1, 1, '2016-03-31', 10, 20, 30, 50);
...
(15, 5, 1, 1, 'Chichén-Itzá', 'Mérida - Chichén-Itzá - Mérida', 0, '<p>A las 09:00 de la ma&ntilde;ana pasaremos por usted a su hotel para dirigirnos a esta gran zona arqueol&oacute;gica, considerada el centro ceremonial m&aacute;s grande y m&aacute;s importante de los mayas; tendremos una visita guiada a los puntos m&aacute;s importantes como: El Castillo, el juego de pelota, el Cenote Sagrado, El Observatorio etc. Despu&eacute;s del recorrido tendremos una comida bufete en el restaurante tur&iacute;stico m&aacute;s reconocido de la zona, y posteriormente regresaremos a M&eacute;rida, llegando aproximadamente a las 17:00 horas.</p>\n<p>&nbsp;</p>\n<p><strong>Incluye: Transportaci&oacute;n, Servicio de Gu&iacute;a, Comida e Impuestos.</strong></p>\n<p>&nbsp;</p>\n<p><strong>No Incluye: Admisiones, Bebidas con los alimentos, Propinas.</strong></p>'),
(16, 5, 2, 1, 'Cuzamá Cenotes & Izamal', 'Cuzamá Cenotes & Izamal', 0, '<p>At 9:00am we will pick you up at your hotel to start our tour towards the enigmatic archeological zone of Chichen-Itzá, considered one of the seven wonders of the world; once there, the tour guide will show us around the different sites of interest, The enormous castle of Kukulcán, followed by the “Ball Game Court” known for being the biggest one in the Americas, then to the temple of the “Thousand Columns,” the sacred Cenote were beautiful damsels were scarified to the Gods, and Going through the “Observatory” known as the “Caracol” or “Snail” in English.</p>\n<p>&nbsp;</p>\n<p>After that we will have lunch at a renown local restaurant called “Xaybé” to enjoy a typical meal, to afterwards return to Mérida at around 17:00 hours.</p>\n<p>&nbsp;</p>\n<p><strong>Includes: Transportation, Tour Guide, Food and Taxes.</strong></p>\n<p>&nbsp;</p>\n<p><strong>Does NOT Include:&nbsp;</strong><strong>Admission Fees,&nbsp;</strong><strong>Beverages and Tips.</strong></p>'),
...
(46, 5, 3, 1, 'Chichén-Itzá', 'Mérida - Chichén-Itzá - Mérida', 0, '<p class="Cuerpo" style="margin-bottom: 0px; padding: 0px; color: rgb(0, 0, 0); font-family: Arial; font-size: 13px; line-height: normal;">Alle 9,00 a.m., verremo a prendervi nel vostro albergo diretti a questa meravigliosa Zona Archeologica, considerata il Centro cerimoniale più grande e importante dei Maya, faremo una visita guidata, per conoscere le strutture più importanti: El Castillo, el Juego de Pelota, el Cenote Sagrado, El Observatorio, ecc. Posteriormente faremo un pranzo buffet in un ristorante turistico, e alla fine torneremo a Merida verso le 17,00 ore.</p><p class="Cuerpo" style="margin-bottom: 0px; padding: 0px; color: rgb(0, 0, 0); font-family: Arial; font-size: 13px; line-height: normal;">Il prezzo comprende: trasporto, servizio di guida, pranzo, &nbsp;e tasse</p><p class="Cuerpo" style="margin-bottom: 0px; padding: 0px; color: rgb(0, 0, 0); font-family: Arial; font-size: 13px; line-height: normal;">Ingressi, Le bibite e mance non sono comprese nel prezzo.</p>'),
(47, 5, 4, 1, 'Chichen-Itza', 'Mérida - Chichén-Itzá - Mérida', 0, '<p style="margin-bottom: 0px; padding: 0px; color: rgb(0, 0, 0); font-family: Arial; font-size: 13px; line-height: normal;">A 09h00, nous viendrons vous chercher à votre hôtel pour aller à ce grand site archéologique, considéré comme le plus grand et le plus important centre cérémoniel de la civilisation maya. Vous profiterez d’une visite guidée sur les points les plus importants : le château , le jeu de balle, le Cenote sacré , l''Observatoire etc. Après la visite, vous pourrez déjeuner dans un restaurant qui offre un buffet puis retour à Merida vers 18h00.</p><p style="margin-bottom: 0px; padding: 0px; color: rgb(0, 0, 0); font-family: Arial; font-size: 13px; line-height: normal;">&nbsp;</p><p style="margin-bottom: 0px; padding: 0px; color: rgb(0, 0, 0); font-family: Arial; font-size: 13px; line-height: normal;">Inclus: transport, guide, nourriture et taxes</p><p style="margin-bottom: 0px; padding: 0px; color: rgb(0, 0, 0); font-family: Arial; font-size: 13px; line-height: normal;">Non inclus: Entrées, les boissons aux repas, les pourboires</p>');
...
--
-- Volcado de datos para la tabla `tour_imagen`
--

INSERT INTO `tour_imagen` (`id`, `id_tour`, `id_estatus`, `nombreoriginal`, `nombre`, `path`, `tipoarchivo`, `folio`, `fechacreacion`, `principal`) VALUES
(1, 1, 1, 'campeche.jpg', 'tour-1-folio-1.jpg', 'bundles/VisitaYucatanBundle/images/tours/tour-1-folio-1.jpg', 'jpg', 1, '2016-02-19 03:37:01', 1),
(2, 1, 1, 'campeche2.jpg', 'tour-1-folio-2.jpg', 'bundles/VisitaYucatanBundle/images/tours/tour-1-folio-2.jpg', 'jpg', 2, '2016-02-19 03:37:51', 0);
...
--
-- Indices de la tabla `hotel_contrato`
--
ALTER TABLE `hotel_contrato`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_2408B751EDD61FE9` (`id_hotel`),
  ADD KEY `IDX_2408B751567A477F` (`id_plan`),
  ADD KEY `IDX_2408B75150BDD1F3` (`id_estatus`);

--
-- Indices de la tabla `hotel_fecha_cierre`
--
ALTER TABLE `hotel_fecha_cierre`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_439F3E3EEDD61FE9` (`id_hotel`),
  ADD KEY `IDX_439F3E3E50BDD1F3` (`id_estatus`);
...
ALTER TABLE `hotel_habitacion`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_818D7F57EDD61FE9` (`id_hotel`),
  ADD KEY `IDX_818D7F5750BDD1F3` (`id_estatus`);

--
-- Indices de la tabla `hotel_habitacion_idioma`
--
ALTER TABLE `hotel_habitacion_idioma`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_E46E74DF62072A86` (`id_hotel_habitacion`),
  ADD KEY `IDX_E46E74DF3BFFEBE1` (`id_idioma`),
  ADD KEY `IDX_E46E74DF50BDD1F3` (`id_estatus`);
...
--
-- Indices de la tabla `hotel_plan`
--
ALTER TABLE `hotel_plan`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_6A9F8DF550BDD1F3` (`id_estatus`);

--
-- Indices de la tabla `hotel_tarifa`
--
ALTER TABLE `hotel_tarifa`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_96EB67B9EDD61FE9` (`id_hotel`),
  ADD KEY `IDX_96EB67B9196E0A57` (`id_hotel_contrato`),
  ADD KEY `IDX_96EB67B962072A86` (`id_hotel_habitacion`),
  ADD KEY `IDX_96EB67B950BDD1F3` (`id_estatus`);
...
ALTER TABLE `hotel_contacto`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de la tabla `hotel_contrato`
--
ALTER TABLE `hotel_contrato`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT de la tabla `hotel_fecha_cierre`
--
ALTER TABLE `hotel_fecha_cierre`
...
ALTER TABLE `hotel_habitacion`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de la tabla `hotel_habitacion_idioma`
--
ALTER TABLE `hotel_habitacion_idioma`
...
ALTER TABLE `hotel_imagen`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `hotel_plan`
--
ALTER TABLE `hotel_plan`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `hotel_tarifa`
--
ALTER TABLE `hotel_tarifa`
...
--
-- Filtros para la tabla `hotel_contrato`
--
ALTER TABLE `hotel_contrato`
  ADD CONSTRAINT `FK_2408B75150BDD1F3` FOREIGN KEY (`id_estatus`) REFERENCES `estatus` (`id`),
  ADD CONSTRAINT `FK_2408B751567A477F` FOREIGN KEY (`id_plan`) REFERENCES `hotel_plan` (`id`),
  ADD CONSTRAINT `FK_2408B751EDD61FE9` FOREIGN KEY (`id_hotel`) REFERENCES `hotel` (`id`);

--
-- Filtros para la tabla `hotel_fecha_cierre`
--
ALTER TABLE `hotel_fecha_cierre`
  ADD CONSTRAINT `FK_439F3E3E50BDD1F3` FOREIGN KEY (`id_estatus`) REFERENCES `estatus` (`id`),
  ADD CONSTRAINT `FK_439F3E3EEDD61FE9` FOREIGN KEY (`id_hotel`) REFERENCES `hotel` (`id`);

--
-- Filtros para la tabla `hotel_habitacion`
--
ALTER TABLE `hotel_habitacion`
  ADD CONSTRAINT `FK_818D7F5750BDD1F3` FOREIGN KEY (`id_estatus`) REFERENCES `estatus` (`id`),
  ADD CONSTRAINT `FK_818D7F57EDD61FE9` FOREIGN KEY (`id_hotel`) REFERENCES `hotel` (`id`);

--
-- Filtros para la tabla `hotel_habitacion_idioma`
--
ALTER TABLE `hotel_habitacion_idioma`
  ADD CONSTRAINT `FK_E46E74DF3BFFEBE1` FOREIGN KEY (`id_idioma`) REFERENCES `idioma` (`id`),
  ADD CONSTRAINT `FK_E46E74DF50BDD1F3` FOREIGN KEY (`id_estatus`) REFERENCES `estatus` (`id`),
  ADD CONSTRAINT `FK_E46E74DF62072A86` FOREIGN KEY (`id_hotel_habitacion`) REFERENCES `hotel_habitacion` (`id`);
...
--
-- Filtros para la tabla `hotel_plan`
--
ALTER TABLE `hotel_plan`
  ADD CONSTRAINT `FK_6A9F8DF550BDD1F3` FOREIGN KEY (`id_estatus`) REFERENCES `estatus` (`id`);

--
-- Filtros para la tabla `hotel_tarifa`
--
ALTER TABLE `hotel_tarifa`
  ADD CONSTRAINT `FK_96EB67B9196E0A57` FOREIGN KEY (`id_hotel_contrato`) REFERENCES `hotel_contrato` (`id`),
  ADD CONSTRAINT `FK_96EB67B950BDD1F3` FOREIGN KEY (`id_estatus`) REFERENCES `estatus` (`id`),
  ADD CONSTRAINT `FK_96EB67B962072A86` FOREIGN KEY (`id_hotel_habitacion`) REFERENCES `hotel_habitacion` (`id`),
  ADD CONSTRAINT `FK_96EB67B9EDD61FE9` FOREIGN KEY (`id_hotel`) REFERENCES `hotel` (`id`);
